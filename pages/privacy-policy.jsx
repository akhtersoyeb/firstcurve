    ...
    <div className="container mx-auto py-10">
      <Card>
        ...
        <CardContent className="prose max-w-none">
          ...
          <p>
            Welcome to Firstcurve ("we," "our," or "us"). We respect your privacy and are committed to protecting
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-4">2. The Data We Collect About You</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-4">3. How We Use Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-4">6. Your Legal Rights</h2>
          <p>
